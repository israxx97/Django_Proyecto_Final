    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bodega', models.CharField(max_length=70, verbose_name='Bodega')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volumen', models.PositiveIntegerField(verbose_name='Volumen (cL)')),
                ...
                ('imagen', models.ImageField(blank=True, null=True, upload_to='vinos', verbose_name='Imagen')),
                ('precio', models.FloatField()),
                ('created', models.DateField(auto_now_add=True, verbose_name='Fecha de creación')),
                ('updated', models.DateField(auto_now=True, verbose_name='Fecha de última actualización')),
                ('bodega', models.ManyToManyField(related_name='Bodega', to='core.Bodega')),
                ('tipo', models.ManyToManyField(help_text='T1 - Tinto; T2 - Verdejo; T3 - Rosado;', related_name='Tipo', to='core.Tipo')),
            ],
            options={
                'verbose_name': 'Vino',
